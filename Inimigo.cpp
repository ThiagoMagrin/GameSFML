...
namespace Entidades
{
    namespace Personagens
    {
        namespace Inimigos
        {
            ...
            Inimigo::Inimigo(Jogador *pJogador) : Personagem(), pJogador(pJogador), pJogador2(nullptr)
            {
                setID(2);
            }

            Inimigo::Inimigo(Jogador *pJogador, Jogador *pJogador2) : Personagem(), pJogador(pJogador), pJogador2(pJogador2)
            {
                setID(2);
            }
