...
{
    GerenciadorColisao::GerenciadorColisao() : ListaEntidadeEstatica(nullptr),
                                               ListaEntidadeMovimento(nullptr)
    {
    }
    GerenciadorColisao::GerenciadorColisao(ListaEntidade *LEstatica, ListaEntidade *LMovimento) : ListaEntidadeEstatica(LEstatica),
        ...
        for (int i = 0; i < tamLMovimento; i++)
        {
            for (int j = 0; j < tamLEstatica; j++)
            {
                ...
                if (colide)
                {
                    ...
                    entidade2->tratarColisao(entidade1);
                }
